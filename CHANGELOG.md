...
### Added
- Add `htmlAsMarkdown` to `CleanMessagesRequest` for the message clean API
...
### Fixed
- Preserve metadata key casing in multipart form-data requests ([#729](https://github.com/nylas/nylas-nodejs/pull/729))

### Changed
- Refresh README — fix dashboard URL, drop v3-beta paths, cross-link to developer.nylas.com ([#728](https://github.com/nylas/nylas-nodejs/pull/728))

## [8.1.0] - 2026-05-05

### Added
- Add Agent Accounts SDK support ([#724](https://github.com/nylas/nylas-nodejs/pull/724))
- Add support for large attachments ([#725](https://github.com/nylas/nylas-nodejs/pull/725))
